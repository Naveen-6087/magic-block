...
declare_id!("CodYjPSj9JePDk1wqiKWn4qQJxnKgxV8tY59DSiT1dR7");
    ...
    pub fn delegate(ctx: Context<DelegateInput>) -> Result<()> {
        ctx.accounts.delegate_pda(
            ...
            DelegateConfig {
                ...
                // Using Asia validator for better performance from India
                validator: Some(solana_program::pubkey!("ASLxD38WUHStVbUGm4BW7WZNSThwzZYTr6Qz4eohf3Xp")), // Asia ER validator
                // validator: Some(solana_program::pubkey!("EUhi4xecUqEUmGgBCoGomeEiUprwu2D2oM2QmwMjzM75")), // Europe ER validator
                // validator: Some(solana_program::pubkey!("USQT2zbsRiK7dZqVzCktauygDXVAdAgWZbnHJyQo4TV")), // US ER validator
            },
        )?;
        Ok(())
    }
